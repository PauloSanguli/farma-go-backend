...
from src.infra.http.middleware.authorizators import JWTTokenExceptionHandler
...
async def list_pharmacys(
    admin_logged: Annotated[dict, Depends(JWTTokenExceptionHandler.get_admin_logged)],
):
